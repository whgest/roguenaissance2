# XML Parser/Data Access Object C:\Users\wgest\Desktop\ProjectR\Roguenaissance\text.py
"""AUTO-GENERATED Source file for C:\\Users\\wgest\\Desktop\\ProjectR\\Roguenaissance\\text.py"""
import xml.sax
import Queue
...
class text_q2class(Q2API.xml.base_xml.XMLNode):
    def __init__(self, attrs):
        self.level = 2
        self.path = [None, u'textblocks']
        Q2API.xml.base_xml.XMLNode.__init__(self, "text", attrs, None, [])

class textblocks_q2class(Q2API.xml.base_xml.XMLNode):
    def __init__(self, attrs):
        self.level = 1
        self.path = [None]
        self.text = []
        Q2API.xml.base_xml.XMLNode.__init__(self, "textblocks", attrs, None, [])
...
class NodeHandler(xml.sax.handler.ContentHandler):
    ...
    def startElement(self, name, attrs): # creating the node along the path being tracked
        ...
        elif name == "textblocks":
            self.obj_depth.append(textblocks_q2class(p_attrs))
