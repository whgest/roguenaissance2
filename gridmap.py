...
class GridMap(object):
    ...
    def move_cost(self, c1, c2):
        ...
        return abs(c1[0] - c2[0]) + abs(c1[1] - c2[1])   #replaced euclidian distance with taxicab distance
        ...
        for drow in (-1, 0, 1):
            for dcol in (-1, 0, 1):
                ...
                if (    0 <= newrow <= self.nrows - 1 and
                    ...
                    if newcol == c[1] or newrow ==c[0]:   #added this conditional to prevent diagonal movement
